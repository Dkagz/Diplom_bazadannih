namespace InventoryManagementSystem
{
    partial class about
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label2.Text = "Бағдарлама С. Сейфуллин атындағы Қазақ Агротехникалық Университетінің, \r\nКЖжКББ ф" +
    "акультетінің, ЕТжБҚЕ мамандығының 4 курс студентімен әзірленген.";
            ...
            this.label3.Text = "Автор: Капашева Дайана Ерсайновна\r\n2022 ж.";
